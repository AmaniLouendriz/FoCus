import './AppHeader.css'; // Make sure the path is correct
...
export const AppHeader = ()=>{
    return (
        <div className="header">
            ...
            {/* heehjeje */}
            <nav className="navbar navbar-expand-xl bg-secondary-subtle">
                <div className="container-fluid">
                    <a className="navbar-brand branderWrapper" href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-emoji-sunglasses" viewBox="0 0 16 16">
                    ...
                    <div className="collapse navbar-collapse btnWrapper" id="navbarNav">
                    {/* add active to the className to style it accordingly */}
