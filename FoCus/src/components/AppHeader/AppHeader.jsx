...
export const AppHeader = ()=>{
    return (
        <div className="header">
            ...
            {/* heehjeje */}
            <nav class="navbar navbar-expand-xl bg-secondary-subtle">
                <div class="container-fluid">
                    <a class="navbar-brand branderWrapper" href="#">
                    ...
                    <div class="collapse navbar-collapse btnWrapper" id="navbarNav">
                    {/* add active to the class to style it accordingly */}
                        <ul class="navbar-nav">
                            <li class="nav-item">
